...
function createOrder() {
    ...
    orderCompositions.push({orderNumber: orderCount, ingredients: [ingredientsList[1]], beverages: [], beveragesOrdered: false, ingredientsPrepared: false, beveragesPrepared: false});
...
function isCurrentIgredientCorrect(e) {
...
document.addEventListener("keydown", function (e) {
    ...
    if(isKeyInBeveragesList(e) == true) {
       $(".beverage").last().animate({right: "+=250px"}, 100 );
       isCurrentIgredientCorrect(e);
